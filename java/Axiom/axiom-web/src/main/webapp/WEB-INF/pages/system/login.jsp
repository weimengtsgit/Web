...
<body class="login">
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="login-form" action="${ctx}login.html" method="post">
		...
		<form class="forget-form" action="${ctx}login.html" method="post">
		...
		<form class="register-form" action="${ctx}login.html" method="post">
			<h3 >Sign Up</h3>
	...
	<script src="${ctx}assets/scripts/login-soft.js" type="text/javascript"></script>      
	<!-- END PAGE LEVEL SCRIPTS --> 
	<script>
