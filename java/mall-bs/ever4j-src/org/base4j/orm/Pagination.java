...
public class Pagination implements Serializable
{
	...
	private int pageSize =Constant.configMap.get("sysbaseConfig_pageSize")==null?20:Integer.parseInt(Constant.configMap.get("sysbaseConfig_pageSize"));//每页显示记录条数，默认20条
