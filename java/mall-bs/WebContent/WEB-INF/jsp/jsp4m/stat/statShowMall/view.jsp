							...
							<form class="form-inline" role="form" onsubmit="return false;">
								<a href="#" class="btn search default pull-right "><i
									class="fa fa-search"></i></a>
										<div class="input-group input-large date-picker input-daterange pull-right"
											data-date-format="yyyy-mm-dd">
											
											<input id="startDate"
												required="true" type="text" class="form-control" name="startDate">
...
<script type="text/javascript">
	...
	function init() {
		$.ajax({
			type : "POST",
			url : "${ctx}/stat/statShowMall/init",
	...
	function fresh() {
		$.ajax({
			type : "POST",
			url : "${ctx}/stat/statShowMall/fresh",
			success : function(obj) {
				if (obj) {
					$('#totalPv').text(obj.totalPv);
	...
	function chart() {
		$.ajax({
			type : "POST",
			url : "${ctx}/stat/statShowMall/chart",
			success : function(obj) {
				if (obj) {
