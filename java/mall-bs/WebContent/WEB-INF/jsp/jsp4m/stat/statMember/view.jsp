...
<div class="row">
	...
	<div class="col-md-4">
		<div class="dashboard-stat purple">
			...
			<div class="details">
				<div id="yesterday" class="number">0</div>
				<div class="desc"></div>
			</div>
			<a class="more" href="#"> 昨日新增<i
				class="m-icon-swapright m-icon-white"></i>
			</a>
		</div>
	</div>
