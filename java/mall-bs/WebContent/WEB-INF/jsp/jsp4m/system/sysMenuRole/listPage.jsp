...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/system/sysMenuRole/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_SYSTEM_SYSMENUROLE_" ></c:set>
<c:set scope="page" var="dataTitle" value="角色权限" ></c:set>
<c:set scope="page" var="tableId" value="data-table-system-sysMenuRole-1" ></c:set>
<div class="row">
				<div class="col-md-12">
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 uxDrapable:false,
	 aoColumns: [		
			{sTitle:'角色ID',  mData: "roleId",uxLongText:true},				
			{sTitle:'菜单ID',  mData: "menuId",uxLongText:true},		        
          {uxCogs:[
	          {name:"查看"}
