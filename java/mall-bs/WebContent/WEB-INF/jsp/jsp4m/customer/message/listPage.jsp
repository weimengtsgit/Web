...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/customer/message/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_CUSTOMER_MESSAGE_" ></c:set>
<c:set scope="page" var="dataTitle" value="站内信" ></c:set>
<c:set scope="page" var="tableId" value="data-table-customer-message-1" ></c:set>
<div class="row">
				<div class="col-md-12">
...
<!-- 								</div> -->
								...
								<div class="form-group pull-right">
									<input placeholder='客户'  class="form-control form-control-inline input-medium   select2 " name="filter_EQI_customer.id" type="hidden"  result-field="mobile"   lookup-url="${ctx }/customer/customer/listJSON" filter="filter_LIKES_mobile" />
								</div>
							
	
								<div class="form-group pull-right">
									<input type="text" class="form-control form-control-inline input-small " name="filter_LIKES_title"  placeholder="标题">
								</div>
							
	
								<div class="form-group pull-right">
									<input type="text" class="form-control form-control-inline input-small " name="filter_LIKES_msgContent"  placeholder="内容">
								</div>
								...
								<div class="form-group pull-right">
									<tag:enum name="filter_EQT_isRead"  attrs="placeholder='是否已读'" cssClass="form-control form-control-inline input-small select2me"  enumName="customer_Message_isRead" tagType="edit" />
								</div>
...
// 			{sTitle:'null',  mData: "mallId",uxLongText:true},		
			...
			{sTitle:'标题',  mData: "title",uxLongText:true},				
			{sTitle:'内容',  mData: "msgContent",uxLongText:true},		
			{sTitle:'发送时间',  mData: "sendTime" , mRender: Common.formatDate},			
			{sTitle:'阅读时间',  mData: "readTime" , mRender: Common.formatDate},			
			{sTitle:'是否已读',mData: "isRead" ,uxEnum:'customer_Message_isRead'},        
          {uxCogs:[
	          {name:"查看"}
