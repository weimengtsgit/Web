...
<style>
.fa-item:hover [class^="fa-"]:before, .fa-item:hover [class*=" fa-"]:before {
	color:red;
}
</style>
<h3>4.0 版本中新增的图标</h3>
<div id="pages-fa-icons">
...
$(document).ready(function() {
	$('#pages-fa-icons .fa-item').click(function(){
// 		alert($(this).text());
		var icon = "fa "+$(this).text();
		_GLOBAL.lastHandler.parent().parent().children('input').val(icon);
		_GLOBAL.lastHandler.parent().parent().find('i').first().removeClass();
		_GLOBAL.lastHandler.parent().parent().find('i').first().addClass(icon);
		_GLOBAL.lastModal.modal('hide');
	})
})
